...
disp(['Ice-thinning since glacial maximum:' char(9) '{' char(9) num2str(round(min(ic)))  char(9) '-'  char(9)  num2str(round(max(ic))) char(9) '}'  char(9)...
    ...
    'm'])
disp(['Weathering:' char(9)  '{' char(9) num2str(min(W)*1e4,4) char(9) '-'  char(9) num2str(max(W)*1e4,4) char(9) '}'  char(9)...
    num2str(results.W(2)*1e4,4)  char(9)...
    '['  char(9) num2str(results.W(1)*1e4,4) char(9) '-'  char(9) num2str(results.W(3)*1e4,4) char(9) ']' char(9)...
    'mm/ka'])
disp(['Glacial erosion:' char(9)  '{' char(9) num2str(min(E)*1e4,4) char(9) '-'  char(9) num2str(max(E)*1e4,4) char(9) '}'  char(9)...
    num2str(results.E(2)*1e4,4) char(9)...
    '['  char(9) num2str(results.E(1)*1e4,4) char(9) '-'  char(9) num2str(results.E(3)*1e4,4) char(9) ']' char(9)...
    'mm/ka'])
disp(['Uplift rate:' char(9) '{' char(9) num2str(min(UR),4) char(9) '-'  char(9) num2str(max(UR),4) char(9) '}'  char(9)...
    num2str(results.UR(2),4) char(9)...
     '['  char(9) num2str(results.UR(1),4) char(9) '-'  char(9) num2str(results.UR(3),4) char(9) ']' char(9)...
     'm/Ma'])
disp(['Deviation of current ice level:' char(9) '{' char(9) num2str(round(min(DELTAH))) char(9) '-'  char(9) num2str(round(max(DELTAH))) char(9) '}'  char(9)...
    num2str(round(results.DELTAH(2))) char(9)...
    '['  char(9) num2str(round(results.DELTAH(1))) char(9) '-'  char(9) num2str(round(results.DELTAH(3))) char(9) ']' char(9)...
    'm'])
% disp('-----------------------------------------------')               
disp(' ')
end % end function
